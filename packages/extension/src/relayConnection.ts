...
export class RelayConnection {
  ...
  private _targetWindowId: number | undefined;
  ...
  get claimedTabs(): ReadonlySet<number> {
    return new Set([...this._attachedTabs, ...this._pendingTabs]);
  }
  ...
  private async _handleCommand(message: ProtocolCommand): Promise<any> {
    ...
    if (message.method === 'chrome.tabs.create')
      args[0] = { ...args[0], active: false, windowId: this._targetWindowId };
